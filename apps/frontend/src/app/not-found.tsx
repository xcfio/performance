            ...
            <div className="font-comfortaa min-h-screen bg-linear-to-br from-blue-900 via-teal-900 to-blue-900 flex items-center justify-center p-4 overflow-hidden relative">
                ...
                >
                    ...
                    <div className="button-container flex justify-center">
                        <button
                            onClick={() => router.back()}
                            className="px-6 py-3 rounded-lg font-semibold transition-all hover:scale-105 active:scale-95 inline-flex items-center justify-center gap-2 border-2 border-teal-500 text-teal-500 bg-transparent hover:bg-teal-500 hover:text-white hover:shadow-[0_10px_25px_rgba(20,184,166,0.3)]"
                        >
