...
export default function ErrorFallback({ error, reset }: ErrorPageProps) {
    ...
    return (
        <>
            <main className="min-h-screen bg-linear-to-br from-blue-900 via-teal-900 to-blue-900 flex items-center justify-center p-4 overflow-hidden relative">
                ...
                <div
                    className={`w-full max-w-2xl flex flex-col gap-8 md:gap-6 relative z-10 transition-all duration-1000 ease-out ${
                ...
                >
                    ...
                    {/* Error Card */}
                    <div
                        className="error-card bg-black/30 border border-teal-500/20 rounded-2xl overflow-hidden backdrop-blur-sm"
                        role="alert"
                        aria-live="assertive"
                    >
                        {/* Info rows */}
                        ...
                        <div className="px-5 py-4 flex flex-col gap-2">
                            ...
                            <p
                                ...
                                className="text-teal-50 font-mono text-xs m-0 leading-relaxed"
                            >
                                {errorMessage}
                            </p>
                        </div>
                        ...
                        <div className="border-t border-teal-500/20 px-5 py-4 flex flex-col gap-2">
                            ...
                            <pre
                                ...
                                tabIndex={0}
                                className="text-teal-200/60 font-mono text-[11px] m-0 overflow-x-auto whitespace-pre-wrap break-all leading-relaxed max-h-36 overflow-y-auto scrollbar-thin focus-visible:outline-2 focus-visible:outline-teal-400 rounded-md p-1"
                            >
                                {stackTrace}
                            </pre>
                        </div>
                    ...
                    {/* Actions */}
                    <div className="button-container flex flex-col sm:flex-row gap-3 justify-center">
                        <button
                            onClick={() => router.back()}
